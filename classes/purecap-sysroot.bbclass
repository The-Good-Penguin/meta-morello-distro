...
# In general having multiple versions of the same package is a massive PITA, be warned.

# Yes it would be easier to have "pure" purecap distro, but this is more practical. You get
# a normal Yocto distro with the experimental purecap on the side to play with.
...
# Yes, yes, I know, how sad
INSANE_SKIP:${PN}    += "file-rdeps"
EXCLUDE_FROM_SHLIBS   = "1"
do_package_qa[noexec] = "1"

# Stop right there debian class, do not create pkg duplicates, kind regards
AUTO_LIBNAME_PKGS = ""
