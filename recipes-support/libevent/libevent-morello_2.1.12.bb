inherit autotools ptest purecap-sysroot

MORELLO_SRC = "poky/meta/recipes-support/libevent/libevent_2.1.12.bb"
...
PACKAGECONFIG ??= ""
PACKAGECONFIG[openssl] = "--enable-openssl,--disable-openssl,openssl-morello"
